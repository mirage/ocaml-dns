...
(* OASIS_START *)
(* DO NOT EDIT (digest: fc680e230fce4abebe039751a7cc9cfa) *)
(*
...
# 21 "/Users/avsm/.opam/3.12.1+mirage-unix-direct/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
                      lib_findlib_name = Some "resolver";
                      lib_findlib_containers = [];
                      });
               Doc
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Þæ¨ BÆ\128\026Òj\022\022ÆbÙ\131";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
