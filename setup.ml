...
(* OASIS_START *)
(* DO NOT EDIT (digest: 000f7aa883dfe05e9600fe2b430c2b37) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Async_kernel library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ipaddr",
                               Some (OASISVersion.VGreaterEqual "2.6.0"));
                           FindlibPackage
                             ("base64",
                           ...
                           FindlibPackage
                             ("uri.services",
                               Some (OASISVersion.VGreaterEqual "1.7.0"));
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Dns_server"; "Dns_resolver"; "Mdns_responder"];
                      lib_pack = false;
                      lib_internal_modules = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-kv-lwt", None);
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Async_dns_resolver"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Async_dns_resolver_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
                      lib_findlib_name = Some "async-unix";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "dig_unix.ml"});
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("async", None);
                           InternalLibrary "dns-async-unix"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "dns";
                           InternalLibrary "dns-lwt-core";
                           InternalLibrary "dns-lwt-mirage";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "A\030$J\141\0199\244\158f,{zf\127E";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
