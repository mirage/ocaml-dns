...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5b25aec74303e6e96d0ce04f2f928acb) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ipaddr",
                               Some (OASISVersion.VGreaterEqual "0.2.2"))
                        ];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dns_server_core"; "Dns_resolver_core"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\007+^b\159G@õB\132zMéé°¸";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
