...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e3a063663efbf96c8b3e0607ffd83ca) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("dns_async", OCamlbuildDocPlugin.doc_build "async")
       ];
     ...
     clean_doc =
       [
          ...
          ("dns_async", OCamlbuildDocPlugin.doc_clean "async")
       ];
     distclean = [];
     distclean_test =
       [
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "get_nameserver.ml"; });
               Executable
                 ({
                     cs_name = "async_mldig";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "async_mldig.ml"; })
            ];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "c\169\018\180\244\188wv*\004D}\143\128\232\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
