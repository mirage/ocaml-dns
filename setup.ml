...
(* OASIS_START *)
(* DO NOT EDIT (digest: 890fedd79e29a4aa2eadb5d623bf074e) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dns_server"; "Dns_resolver"; "Mldig"];
                      lib_pack = false;
                      lib_internal_modules = [];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Dns_server_unix"; "Dns_resolver_unix"; "Mldig_unix"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "mldig_unix.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ÄçñÜ²¢Q½\146¼\145¨ttg¹";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
