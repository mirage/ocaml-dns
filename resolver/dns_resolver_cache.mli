...
val cached : t -> int64 -> Dns_enum.rr_typ -> Domain_name.t ->
  (Dns_resolver_entry.res * t, [ `Cache_miss | `Cache_drop ]) result

val maybe_insert : Dns_enum.rr_typ -> Domain_name.t -> int64 -> Dns_resolver_entry.rank ->
  Dns_resolver_entry.res -> t -> t

val follow_cname : t -> int64 -> Dns_enum.rr_typ -> Domain_name.t -> Dns_packet.rr list ->
