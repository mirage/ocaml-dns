...
val reserved_zones : Rr_map.t Domain_name.Map.t
(** [reserved_zones] is a domain-name map of reserved zones specified by RFCs
    (6303, 6761, 6762). The values are stub SOA records. *)
