...
@	LOC	|} in
    let loc_strs = [
      ...
      (
        ...
        Loc.parse ~latitude:((52l, 12l, 40000l), true) ~longitude:((0l, 5l, 31000l), false) ~altitude:2200L ~precision:(1000L, 1000L, 1000L),
        "52 12 40 N 0 5 31 W 22m 10m 10m 10m"
      ) ;
      (
      ...
      (
        ...
        Loc.parse ~latitude:((59l, 59l, (59999l)), true) ~longitude:((59l, 59l, (59999l)), false) ~altitude:2137483647L ~precision:(9000000000L, 9000000000L, 9000000000L),
        "59 59 59.999 N 59 59 59.999 W 21374836.47m 90000000m 90000000m 90000000m"
      ) ;
      (
        "59 59 59.999 N 59 59 59.999 W 21374836.48m 90000000m 90000000m 90000000m",
        Loc.parse ~latitude:((59l, 59l, (59999l)), true) ~longitude:((59l, 59l, (59999l)), false) ~altitude:2137483648L ~precision:(9000000000L, 9000000000L, 9000000000L),
        "59 59 59.999 N 59 59 59.999 W 21374836.48m 90000000m 90000000m 90000000m"
      ) ;
      (
        "59 59 59.999 N 59 59 59.999 W 21374836.49m 90000000m 90000000m 90000000m",
        Loc.parse ~latitude:((59l, 59l, (59999l)), true) ~longitude:((59l, 59l, (59999l)), false) ~altitude:2137483649L ~precision:(9000000000L, 9000000000L, 9000000000L),
        "59 59 59.999 N 59 59 59.999 W 21374836.49m 90000000m 90000000m 90000000m"
      ) ;
      (
        "59 59 59.999 N 59 59 59.999 W 42849672.95m 90000000m 90000000m 90000000m",
        Loc.parse ~latitude:((59l, 59l, (59999l)), true) ~longitude:((59l, 59l, (59999l)), false) ~altitude:4284967295L ~precision:(9000000000L, 9000000000L, 9000000000L),
        "59 59 59.999 N 59 59 59.999 W 42849672.95m 90000000m 90000000m 90000000m"
      ) ;
      (
      ...
      (
        "52 12 40 N 0 5 31 W 22m 10m 10m",
        Loc.parse ~latitude:((52l, 12l, 40000l), true) ~longitude:((0l, 5l, 31000l), false) ~altitude:2200L ~precision:(1000L, 1000L, 1000L),
        "52 12 40 N 0 5 31 W 22m 10m 10m 10m"
      ) ;
      (
        "52 12 40 N 0 5 31 W 22m 10m",
        Loc.parse ~latitude:((52l, 12l, 40000l), true) ~longitude:((0l, 5l, 31000l), false) ~altitude:2200L ~precision:(1000L, 1000000L, 1000L),
        "52 12 40 N 0 5 31 W 22m 10m 10000m 10m"
      ) ;
      (
        "52 12 40 N 0 5 31 W 22m",
        Loc.parse ~latitude:((52l, 12l, 40000l), true) ~longitude:((0l, 5l, 31000l), false) ~altitude:2200L ~precision:(100L, 1000000L, 1000L),
        "52 12 40 N 0 5 31 W 22m 1m 10000m 10m"
      ) ;
    ] in
